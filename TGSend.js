...
async  function tgBotNotify(axios,configa,reMindMsg){
    ...
    let data = 'chat_id=' + configa.TG_USER_ID + '&text=' + reMindMsg.text + reMindMsg.desp + '&disable_web_page_preview=true';
    let config = {
        method: 'post',
        url: 'https://api.telegram.org/bot' + configa.TG_BOT_TOKEN + '/sendMessage',
        headers: {
