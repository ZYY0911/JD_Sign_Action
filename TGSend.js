...
async  function tgBotNotify(axios,configa,reMindMsg){
    ...
    let data = 'chat_id=' + configa.tgid + '&text=' + reMindMsg.text + reMindMsg.desp + '&disable_web_page_preview=true';
    let config = {
        method: 'post',
        url: 'https://api.telegram.org/bot' + configa.tgtocken + '/sendMessage',
        headers: {
